...
class Synth {
  ...
  */
  ...
  startListeners(eventEmitter, audioContext) {
    // Keyboard note on / off events.  These should happen "now" = currentTime.
    // eventEmitter.on('NOTE_ON', (noteNumber) => {
    //   this.ampEnvelopeOn(audioContext.currentTime)
    //   this.filterEnvelopeOn(audioContext.currentTime)
    // })
    // eventEmitter.on('NOTE_OFF', (noteNumber) => {
    //   this.ampEnvelopeOff(audioContext.currentTime)
    //   this.filterEnvelopeOff(audioContext.currentTime)
    // })
  ...
  // TODO fix this snce Synth no longer a React component
