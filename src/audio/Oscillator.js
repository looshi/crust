...
export default class Oscillator {
  constructor(props) {
    ...
    // dave -- why doesn't this turn off ?
    this.gainNode.connect(this.output)


    const channelData = new Float32Array(600);
    wavetableData['1109'].forEach((data, index) => {
      channelData[index] = data
    })
    this.computedChannelData = channelData;
